...
std::string Namoa(Graph& myGraph, std::map<long long, Position>& nodes, long long start_node, long long end_node, double& time, double& distance, int& treated, int& found, int& path_size);
